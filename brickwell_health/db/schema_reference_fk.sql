...
ALTER TABLE waiting_period
    ADD CONSTRAINT fk_waiting_period_benefit_category
    FOREIGN KEY (benefit_category_id) REFERENCES benefit_category(benefit_category_id);
...
ALTER TABLE waiting_period
    ...
    FOREIGN KEY (clinical_category_id) REFERENCES clinical_category(clinical_category_id);
...
ALTER TABLE upgrade_request
    ...
    FOREIGN KEY (requested_product_id) REFERENCES product(product_id);
...
ALTER TABLE claim
    ...
    FOREIGN KEY (rejection_reason_id) REFERENCES claim_rejection_reason(rejection_reason_id);
...
ALTER TABLE extras_claim
    ADD CONSTRAINT fk_extras_claim_item
    FOREIGN KEY (extras_item_id) REFERENCES extras_item_code(extras_item_id);
...
ALTER TABLE prosthesis_claim
    ADD CONSTRAINT fk_prosthesis_claim_item
    FOREIGN KEY (prosthesis_item_id) REFERENCES prosthesis_list_item(prosthesis_item_id);
...
ALTER TABLE interaction
    ...
    FOREIGN KEY (outcome_id) REFERENCES interaction_outcome(outcome_id);
...
ALTER TABLE complaint
    ...
    FOREIGN KEY (complaint_category_id) REFERENCES complaint_category(complaint_category_id);
...
ALTER TABLE communication
    ...
    FOREIGN KEY (template_code) REFERENCES communication_template(template_code);
