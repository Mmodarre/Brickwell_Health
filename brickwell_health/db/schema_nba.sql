...
-- Indexes
CREATE INDEX IF NOT EXISTS idx_nba_catalog_category ON nba_action_catalog(action_category);
CREATE INDEX IF NOT EXISTS idx_nba_catalog_channel ON nba_action_catalog(channel);
CREATE INDEX IF NOT EXISTS idx_nba_catalog_active ON nba_action_catalog(is_active) WHERE is_active = TRUE;
...
CREATE TABLE IF NOT EXISTS nba_action_recommendation (
    -- Primary Key
    ...
    -- Foreign Keys
    CONSTRAINT fk_nba_recommendation_member FOREIGN KEY (member_id) REFERENCES member(member_id),
    CONSTRAINT fk_nba_recommendation_policy FOREIGN KEY (policy_id) REFERENCES policy(policy_id),
    CONSTRAINT fk_nba_recommendation_action FOREIGN KEY (action_id) REFERENCES nba_action_catalog(action_id),
...
-- Indexes
CREATE INDEX IF NOT EXISTS idx_nba_recommendation_member ON nba_action_recommendation(member_id);
CREATE INDEX IF NOT EXISTS idx_nba_recommendation_policy ON nba_action_recommendation(policy_id) WHERE policy_id IS NOT NULL;
CREATE INDEX IF NOT EXISTS idx_nba_recommendation_batch ON nba_action_recommendation(batch_id);
CREATE INDEX IF NOT EXISTS idx_nba_recommendation_status ON nba_action_recommendation(status);
CREATE INDEX IF NOT EXISTS idx_nba_recommendation_valid ON nba_action_recommendation(valid_from, valid_until);
CREATE INDEX IF NOT EXISTS idx_nba_recommendation_pending ON nba_action_recommendation(status, valid_from) 
...
CREATE TABLE IF NOT EXISTS nba_action_execution (
    -- Primary Key
    ...
    CONSTRAINT fk_nba_execution_recommendation FOREIGN KEY (recommendation_id) 
        REFERENCES nba_action_recommendation(recommendation_id),
    CONSTRAINT fk_nba_execution_action FOREIGN KEY (action_id) 
        REFERENCES nba_action_catalog(action_id),
    CONSTRAINT fk_nba_execution_member FOREIGN KEY (member_id) REFERENCES member(member_id),
    CONSTRAINT fk_nba_execution_policy FOREIGN KEY (policy_id) REFERENCES policy(policy_id),
...
-- Indexes
CREATE INDEX IF NOT EXISTS idx_nba_execution_member ON nba_action_execution(member_id);
CREATE INDEX IF NOT EXISTS idx_nba_execution_policy ON nba_action_execution(policy_id) WHERE policy_id IS NOT NULL;
CREATE INDEX IF NOT EXISTS idx_nba_execution_action ON nba_action_execution(action_id);
CREATE INDEX IF NOT EXISTS idx_nba_execution_date ON nba_action_execution(executed_at);
CREATE INDEX IF NOT EXISTS idx_nba_execution_sim_date ON nba_action_execution(simulation_date);
CREATE INDEX IF NOT EXISTS idx_nba_execution_recommendation ON nba_action_execution(recommendation_id) 
    WHERE recommendation_id IS NOT NULL;
CREATE INDEX IF NOT EXISTS idx_nba_execution_channel ON nba_action_execution(execution_channel);
...
CREATE OR REPLACE VIEW v_nba_pending_actions AS
SELECT 
    r.recommendation_id,
    r.member_id,
    r.policy_id,
...
CREATE OR REPLACE VIEW v_nba_execution_summary AS
SELECT 
    a.action_category,
    a.action_code,
    a.channel,
...
FROM nba_action_execution e
JOIN nba_action_catalog a ON e.action_id = a.action_id
