...
CREATE INDEX IF NOT EXISTS idx_lhc_member ON lhc_loading(member_id);
CREATE INDEX IF NOT EXISTS idx_lhc_policy ON lhc_loading(policy_id);

-- AGE_BASED_DISCOUNT: Youth discount entitlement (18-29 years)
CREATE TABLE IF NOT EXISTS age_based_discount (
...
CREATE INDEX IF NOT EXISTS idx_abd_member ON age_based_discount(member_id);
CREATE INDEX IF NOT EXISTS idx_abd_policy ON age_based_discount(policy_id);

-- PHI_REBATE_ENTITLEMENT: Government rebate tier per policy
CREATE TABLE IF NOT EXISTS phi_rebate_entitlement (
...
CREATE INDEX IF NOT EXISTS idx_rebate_policy ON phi_rebate_entitlement(policy_id);
CREATE INDEX IF NOT EXISTS idx_rebate_fy ON phi_rebate_entitlement(financial_year);
...
CREATE INDEX IF NOT EXISTS idx_suspension_policy ON suspension(policy_id);
CREATE INDEX IF NOT EXISTS idx_suspension_status ON suspension(status);
...
CREATE INDEX IF NOT EXISTS idx_upgrade_policy ON upgrade_request(policy_id);
CREATE INDEX IF NOT EXISTS idx_upgrade_status ON upgrade_request(request_status);
...
CREATE INDEX IF NOT EXISTS idx_bank_member ON bank_account(member_id);
CREATE INDEX IF NOT EXISTS idx_bank_policy ON bank_account(policy_id);
