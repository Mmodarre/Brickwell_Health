...
-- Indexes
CREATE INDEX IF NOT EXISTS idx_comm_pref_member ON communication_preference(member_id);
CREATE INDEX IF NOT EXISTS idx_comm_pref_policy ON communication_preference(policy_id);
CREATE INDEX IF NOT EXISTS idx_comm_pref_opted_out ON communication_preference(is_opted_in) 
...
-- Indexes
CREATE INDEX IF NOT EXISTS idx_communication_member ON communication(member_id);
CREATE INDEX IF NOT EXISTS idx_communication_policy ON communication(policy_id);
CREATE INDEX IF NOT EXISTS idx_communication_campaign ON communication(campaign_id) 
    WHERE campaign_id IS NOT NULL;
CREATE INDEX IF NOT EXISTS idx_communication_sent ON communication(sent_date);
CREATE INDEX IF NOT EXISTS idx_communication_trigger ON communication(trigger_event_type);
CREATE INDEX IF NOT EXISTS idx_communication_status ON communication(delivery_status);
CREATE INDEX IF NOT EXISTS idx_communication_type ON communication(communication_type);
...
-- Indexes
CREATE INDEX IF NOT EXISTS idx_campaign_resp_campaign ON campaign_response(campaign_id);
CREATE INDEX IF NOT EXISTS idx_campaign_resp_member ON campaign_response(member_id);
CREATE INDEX IF NOT EXISTS idx_campaign_resp_date ON campaign_response(response_date);
CREATE INDEX IF NOT EXISTS idx_campaign_resp_type ON campaign_response(response_type);
CREATE INDEX IF NOT EXISTS idx_campaign_resp_conversion ON campaign_response(conversion_type) 
